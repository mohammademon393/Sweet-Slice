...
const OneClickOrder = () => {
  return (
    <section className="relative w-full py-12 px-6 md:px-20 overflow-hidden">
      {/* Background with Gradient matching your image */}
      <div className="rounded-3xl bg-gradient-to-r from-[#FFC0CB] to-[#FFE4E1] flex flex-col md:flex-row items-center p-8 md:p-12">
        {/* Text Content */}
        <div className="flex-1 text-left z-10">
          ...
          <p className="text-gray-700 text-sm md:text-base mb-6 max-w-md">
            Hit the add to cart button and we will pick out 12 delicious treats
            from our "always available" cupcakes.
          </p>
        ...
        <div className="flex-1 flex justify-center mt-8 md:mt-0 relative">
          <img
            src="/chocolate-drip-cake.png"
            alt="Chocolate Drip Cake with Strawberry"
            className="w-full max-w-[400px] object-contain drop-shadow-2xl transform hover:rotate-3 transition-transform duration-500"
          />
        </div>
      </div>
    </section>
